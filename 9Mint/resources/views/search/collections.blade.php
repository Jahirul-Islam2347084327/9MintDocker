            ...
            <div class="nft-filter-wrapper">
                <div class="nft-filter-bar">
                    <div class="nft-filter-group">
                        ...
                        <input type="text" id="collection-filter-name" value="{{ $filters['q'] ?? '' }}" placeholder="Search by collection name">
                    </div>
                    <div class="nft-filter-group">
                    ...
                    <div class="nft-filter-group">
                        ...
                        <select id="collection-filter-currency" data-initial-value="{{ $filters['currency'] ?? '' }}">
                            <option value="">All</option>
                        </select>
                    </div>
                    <div class="nft-filter-group">
                        <label for="collection-filter-min-price">Min Price</label>
                        <input type="number" id="collection-filter-min-price" min="0" value="{{ $filters['min_price'] ?? '' }}" placeholder="0">
                    </div>
                    <div class="nft-filter-group">
                        <label for="collection-filter-max-price">Max Price</label>
                        <input type="number" id="collection-filter-max-price" min="0" value="{{ $filters['max_price'] ?? '' }}" placeholder="Any">
                    </div>
                    <div class="nft-filter-group nft-filter-check">
                        <label><input type="checkbox" id="collection-filter-in-stock" @checked(($filters['in_stock'] ?? false))> In Stock Only</label>
                    </div>
                    <div class="nft-filter-group nft-filter-check">
                        <label><input type="checkbox" id="collection-filter-one-of-one" @checked(($filters['one_of_one'] ?? false))> 1-of-1 Only</label>
                    </div>
